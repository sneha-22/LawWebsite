        ...
        <div>
            ...
            <div className='pt-20'>
                ...
                <div
                    ...
                    style={{
                        background: "url('https://jayantbhatt.in/wp-content/uploads/2022/04/white-collar-crime.jpg') no-repeat center center fixed",
                ...
                >
                    ...
                    <div className="md:w-1/2 p-4">
                        <img
                            src='https://jayantbhatt.in/wp-content/uploads/2022/04/white-collar-crime.jpg'
                            alt="businesslaws"
                    ...
                    {/* Right half */}
                    <div className="md:w-1/2 p-4">
                        <h1 className="text-4xl font-bold font-[sans-serif] mb-4">Targeted advice across data privacy space</h1>
